...
define('_pn_write_forum', '<a href="../user/?action=msg&amp;do=pn&amp;id=[id]"><img src="../inc/images/forum_pn_ru.gif" alt="" title="Написать [nick] личное сообщение" class="icon" /></a>');
define('_uhr', '&nbsp;часов');
...
define('_config_forum_kat_added', 'Категория добавлена!');
define('_config_forum_kat_deleted', 'Категория удалена!');
...
define('_config_forum_skat_added', 'Суб-категория добавлена!');
define('_config_forum_stopic', 'подзаголовок');
define('_config_forum_skat_edited', 'Суб-категория изменена!');
define('_config_forum_edit_skat', 'Изменить Суб-категорию');
define('_config_forum_skat_deleted', 'Суб-категория удалена!');
...
define('_config_newskats_edit_head', 'Редактировать Категорию');
define('_config_newskats_edited', 'Вы отредактировали категорию!');
...
define('_config_konto_head', 'Данные учетной записи');
define('_config_clankasse_head', 'Обозначения выплата/депозитов');
define('_backup_head', 'Резервное копирование базы данных');
define('_backup_info_head', 'примечание');
define('_backup_info', 'Процесс резервного копирования может занять несколько минут в зависимости от размера базы данных.');
define('_backup_link', 'Создать новую копию базы данных!');
